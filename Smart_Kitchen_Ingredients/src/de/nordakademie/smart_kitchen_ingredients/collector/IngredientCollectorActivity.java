...
public class IngredientCollectorActivity extends Activity implements
	...
	public void afterTextChanged(Editable s) {
		...
		ingredientsList.setAdapter(new ArrayAdapter<IIngredient>(
	...
	private boolean ingredientNameMatchSearchString(IIngredient ingredient) {
		...
		return ingredient.getTitle().toLowerCase(Locale.GERMAN)
	...
	private class FetchDataFromDbAsyncTask extends
		...
		private IIngredientCacheData ingredientDb = new IngredientDb();
