...
public class BarcodeServerConnectorTestHelper {
	...
	public static IApiConnector getBarcodeServerConnector() {
		IApiConnector connector = mock(IApiConnector.class);
		...
		when(connector.getResponseForInput("test", "null")).thenReturn(
				responseString);
